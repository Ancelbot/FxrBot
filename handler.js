  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝘼𝙣𝙘𝙚𝙡 👑;;;\nFN:𝘼𝙣𝙘𝙚𝙡 👑\nORG:𝘼𝙣𝙘𝙚𝙡 👑\nTITLE:\nitem1.TEL;waid=5491162522169:+54 9 11 6252-2169\nitem1.X-ABLabel:𝘼𝙣𝙘𝙚𝙡 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:𝘼𝙣𝙘𝙚𝙡 👑\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, {contacts: {displayName: '𝘼𝙣𝙘𝙚𝙡 👑', contacts: [{vcard}]}}, {quoted: callmsg});
